...
class CouncilChamber:
    ...
    def convene(self, user_input: str, triad: Any) -> Dict[str, Any]:
        ...
        """
        print(f"\n [Council Chamber] Convened due to High Tension/Risk (T={triad.delta_t:.2f}, R={triad.delta_r:.2f})")
        ...
        print(f" [Council Decision] Dominant: {decision['dominant_voice']} | Temp : {final_temp_delta:.2f}")
        return decision
