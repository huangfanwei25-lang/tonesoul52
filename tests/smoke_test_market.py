...
def main():
    ...
    snapshots = [
        QuarterlySnapshot(
            quarter="2024Q4",
            revenue=22.28, gross_margin=0.291, net_income=2.71, eps=2.99,
            inventory=16.44, accounts_receivable=11.84, cash=30.00,
            short_term_debt=0, operating_cash_flow=6.42, free_cash_flow=5.85,
        ),
        QuarterlySnapshot(
            quarter="2025Q1",
            revenue=26.19, gross_margin=0.306, net_income=3.32, eps=3.68,
            inventory=15.77, accounts_receivable=14.87, cash=28.66,
            short_term_debt=0, operating_cash_flow=1.66, free_cash_flow=1.07,
        ),
        QuarterlySnapshot(
            quarter="2025Q2",
            revenue=30.28, gross_margin=0.259, net_income=1.74, eps=2.02,
            inventory=26.92, accounts_receivable=16.57, cash=20.68,
            short_term_debt=2.39, operating_cash_flow=-8.56, free_cash_flow=-8.50,
        ),
        QuarterlySnapshot(
            quarter="2025Q3",
            revenue=38.07, gross_margin=0.328, net_income=6.43, eps=6.87,
            inventory=28.74, accounts_receivable=24.19, cash=24.95,
            short_term_debt=1.83, operating_cash_flow=-0.16, free_cash_flow=-0.44,
        ),
        QuarterlySnapshot(
            quarter="2025Q4",
            revenue=48.07, gross_margin=0.332, net_income=8.73, eps=9.29,
            inventory=53.85, accounts_receivable=32.92, cash=16.45,
            short_term_debt=13.14, operating_cash_flow=-15.69, free_cash_flow=-16.12,
        ),
    ]
