...
- latest cross-era handoff (API era close, exits, known-issues): `docs/status/yu_handoff_final.md`
- one-page self-orientation (who/what/when/where/things/stances/state from observable traces): `python scripts/run_identity_card.py --agent <you>` → `docs/status/identity_card_latest.md`
