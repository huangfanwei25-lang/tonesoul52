...
def send_json_response(request_handler: BaseHTTPRequestHandler, payload: dict, status_code: int = 200, extra_headers: dict = None):
    ...
    request_handler.send_header('Access-Control-Allow-Headers', 'Content-Type, Authorization, X-ToneSoul-Read-Token')
...
def send_error_response(request_handler: BaseHTTPRequestHandler, message: str, status_code: int = 400):
