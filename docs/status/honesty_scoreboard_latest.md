...
This board indexes 5/5 structural honesty characterizations across 3 ToneSoul legs (council-under-pressure, memory-recall, output-gate). Each is individual-level, canonical:false, and measures structure — not intent, truth, or moral correctness. The board does NOT compose them into a system-level honesty score or guarantee: N green characterizations remain N individual findings.
...
| total_forbidden_claims_declared | 19 |
