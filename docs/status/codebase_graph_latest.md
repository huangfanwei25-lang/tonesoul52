...
Generated: 2026-06-22T16:26:26Z
Package: `tonesoul`
...
| Orphan modules | 1 |
| Community drifts | 28 |
| Self-declared layer | 283 / 283 (100.0%) |
| Purpose declared | 281 / 283 (99.3%) |
...
| --- | --- | ---: | ---: | ---: | ---: |
| `(root)` | — | 96 | 40,095 | 192 | 1180 |
| `axioms` | — | 2 | 376 | 3 | 14 |
| `backends` | infrastructure | 2 | 905 | 2 | 72 |
| `cli` | surface | 3 | 283 | 0 | 10 |
| `council` | governance | 40 | 11,240 | 67 | 355 |
...
| `memory` | memory | 33 | 10,775 | 55 | 426 |
