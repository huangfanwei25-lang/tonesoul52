...
> **⚠️ Routing.** This doc maps **theory → implementation** at the subsystem level (MDL, Lex Lattice, Sovereign Delta, Isnād). It is **not** a file-level index and does not enumerate the live Python module set in `tonesoul/`.
