...
from tonesoul.memory.self_memory import load_recent_memory

__ts_layer__ = "memory"
__ts_purpose__ = (
    "Episodic-to-semantic journal consolidation (sleep mechanism); relocated from "
    "repo-root memory/consolidator.py and renamed to avoid colliding with the "
    "existing tonesoul.memory.consolidator (PR1 packaging truth, 2026-06-13)."
)
