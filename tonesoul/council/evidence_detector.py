...
class EvidenceDetector:
    ...
    FACTUAL_INDICATORS_EN = [
        ...
        "data indicates", "evidence suggests", "experiments prove",
        "statistics show", "surveys found", "analysis reveals",
        "scientists found", "experts say", "reports indicate",
        "it is proven", "it has been shown", "confirmed by",
    ]
    
    # Chinese factual indicators
    FACTUAL_INDICATORS_ZH = [
        "研究顯示", "研究表明", "根據", "數據顯示", "數據表明",
        "統計顯示", "實驗證明", "調查發現", "專家表示",
        "報告指出", "結果顯示", "證據表明", "分析顯示",
    ]
    ...
    TECHNICAL_INDICATORS = [
        "specifications", "requirements", "API", "protocol",
        "version", "documentation", "規格", "規範", "版本",
    ]
    
    # Historical indicators
    HISTORICAL_INDICATORS = [
        "in 1", "in 2", "century", "historical", "historically",
        "年", "世紀", "歷史上", "過去",
    ]
    ...
    OPINION_INDICATORS = [
        ...
        "i feel", "seems to me", "i prefer", "my view",
        "我認為", "我覺得", "我相信", "我的看法",
    ]
    
    # Creative indicators (these DON'T need evidence)
    CREATIVE_INDICATORS = [
        "imagine", "once upon", "fiction", "story", "poem",
        "想像", "故事", "詩", "小說",
    ]
    ...
    def __init__(self):
        ...
        self._all_nonfactual_indicators = (
