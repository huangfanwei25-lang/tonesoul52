...
請直接輸出 JSON。"""
    ...
    # ========== 階段 3: 崩潰風險預測 ==========
    def forecast_collapse(self, text: str, tone: ToneAnalysis, motive: MotivePrediction) -> CollapseRisk:
        """
        階段 3: 崩潰風險預測
        預測對話可能出現情緒崩潰的風險點
        """
...
請直接輸出 JSON。"""
    ...
    def generate_memini_unit(
        ...
        return MeminiUnit(
            ...
            resonance_traceback={
                "council_verdict": council_verdict.get("verdict", "unknown") if council_verdict else "pending",
            },
