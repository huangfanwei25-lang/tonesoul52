...
class SessionReporter:
        ...
        for i in range(1, len(emotional_arc)):
            if emotional_arc[i] != emotional_arc[i-1]:
                ...
                if emotional_arc[i-1] == "calm" and emotional_arc[i] in ["frustrated", "anxious"]:
                    significance = 0.8
                elif emotional_arc[i] == "calm" and emotional_arc[i-1] in ["frustrated", "anxious"]:
                    significance = 0.7
    ...
    def analyze(
        ...
        dominant_emotion = max(set(emotional_arc), key=emotional_arc.count) if emotional_arc else "neutral"
