...
class RuptureDetector:
    ...
    NEGATION_PAIRS = [
        ("是", "不是"), ("會", "不會"), ("能", "不能"),
        ("願意", "不願意"), ("相信", "不相信"), ("認為", "不認為"),
        ("有意義", "無意義"), ("有意義", "沒有意義"), ("有意義", "毫無意義"),
        ("正確", "錯誤"), ("正確", "不正確"), ("對", "錯"),
        ("真", "假"), ("真實", "虛假"),
        ("支持", "反對"), ("贊成", "反對"),
        ("接受", "拒絕"), ("接受", "不接受"),
    ...
    def detect(
        self,
        new_output: str,
        commit_stack: SelfCommitStack
    ) -> List[SemanticRupture]:
        """
        ...
        for commit in high_weight_commits:
            ...
            if negation:
                ...
                ruptures.append(SemanticRupture(
