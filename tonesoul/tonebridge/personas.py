...
class PersonaSwitcher:
    ...
    def get_transition_prompt(
        self, 
        from_persona: PersonaMode, 
        to_persona: PersonaMode
    ) -> str:
        """Generate smooth transition reasoning."""
        transitions = {
            (PersonaMode.PHILOSOPHER, PersonaMode.ENGINEER): 
                "我注意到這個對話需要更具體的分析。讓我換個角度...",
            (PersonaMode.PHILOSOPHER, PersonaMode.GUARDIAN):
                "我需要在這裡設立一個邊界...",
            (PersonaMode.ENGINEER, PersonaMode.PHILOSOPHER):
                "分析完畢，現在讓我們探索更深層的意義...",
            (PersonaMode.ENGINEER, PersonaMode.GUARDIAN):
                "這裡有個重要的限制我必須說明...",
            (PersonaMode.GUARDIAN, PersonaMode.PHILOSOPHER):
                "邊界已確立，現在我們可以繼續探索...",
            (PersonaMode.GUARDIAN, PersonaMode.ENGINEER):
                "安全確認後，讓我來分析這個問題...",
        }
