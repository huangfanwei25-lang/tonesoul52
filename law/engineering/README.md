...
> Purpose: mirrored law/governance lane for the engineering document family owned by `docs/engineering/`.
> Status: mirror surface; resync from canonical owner when drift is detected.
